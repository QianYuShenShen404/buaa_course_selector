...
> 🚀 专为北航学生打造的智能选课助手 - 方案二独立版本，混合架构设计，极致的选课体验！

## 📌 项目简介

这是北航选课系统自动化工具的**方案二（混合架构）**独立版本。该方案结合了Playwright自动登录的可靠性和HTTP直接请求的高效性，实现了最佳的选课体验，是**推荐的首选方案**。

### 🌟 为什么选择方案二？

- **✅ 成功率超高**：95%+的选课成功率，行业领先
